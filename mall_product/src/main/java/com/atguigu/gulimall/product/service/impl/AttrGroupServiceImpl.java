...
public class AttrGroupServiceImpl extends ServiceImpl<AttrGroupDao, AttrGroupEntity> implements AttrGroupService {
    ...
    @Override
    public List<SpuItemAttrGroupVo> getAttrById(Long spuId, Long catalogId) {
        //1. 查出当前spu对应的所有属性的分组信息以及当前分组下的所有值
        AttrGroupDao baseMapper = this.getBaseMapper();
        List<SpuItemAttrGroupVo> vo = baseMapper.getAttribute(spuId,catalogId);
        return vo;
    }
}